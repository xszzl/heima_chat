...
public class UserServiceImpl implements UserService {
    ...
    public void register(TbUser user) {
        try {
            ...
            String filePath = tempDir + user.getUsername() + ".png";
            qrCodeUtils.createQRCode(filePath,qrcodeStr);

            // 将临时保存的二维码上传到FastDFS
            String url = env.getProperty("fdfs.httpurl") + fastDFSClient.uploadFile(new File(filePath));
